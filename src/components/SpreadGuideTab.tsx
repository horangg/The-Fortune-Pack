...
const SPREADS: SpreadDef[] = [
  {
    ...
    readingSteps: [
      ...
      { text: '카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.', highlightPositionId: 1 }
    ],
    positions: [
      { id: 1, name: '원 카드', meaning: '카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ]
  },
  {
    ...
    readingSteps: [
      ...
      { text: '과거. 최근에 일어났던 일이나 발생한 사건, 배경을 상징합니다.', highlightPositionId: 1 },
      { text: '현재. 질문자가 현재 처한 상황이나 느끼고 있는 상태를 보여줍니다.', highlightPositionId: 2 },
      { text: '미래. 앞으로 가까운 미래에 전개될 상황이나 다가올 주요 영향력을 나타냅니다.', highlightPositionId: 3 },
  ...
  },
  {
    ...
    readingSteps: [
      ...
      { text: '본인 / 질문과 관련된 현재 상황 (중앙에 놓음)', highlightPositionId: 1 },
      { text: '장애물 혹은 보완 요소 (1번 카드 위에 가로질러 놓음)', highlightPositionId: 2 },
      { text: '도달할 수 있는 최고의 목표/환경적 최선 (1번의 위)', highlightPositionId: 3 },
      { text: '무의식적 기초 / 리딩을 하게 된 근본적 이유 (1번의 아래)', highlightPositionId: 4 },
      { text: '과거의 영향 (1번의 왼쪽)', highlightPositionId: 5 },
      { text: '가까운 미래 (1번의 오른쪽)', highlightPositionId: 6 },
      { text: '본인의 현재 태도나 마음가짐 (우측 세로 열의 맨 아래)', highlightPositionId: 7 },
      { text: '주변 환경 및 외적 영향력 (7번의 위)', highlightPositionId: 8 },
      { text: '희망 혹은 두려움 (8번의 위)', highlightPositionId: 9 },
      { text: '최종 결과 (9번의 위, 세로 열의 맨 꼭대기)', highlightPositionId: 10 }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: 'Significator 카드를 뽑아 중앙에 위치합니다.', highlightPositionId: 1 },
