...
const SPREADS: SpreadDef[] = [
  {
    ...
    readingSteps: [
      ...
      { text: '3. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.', highlightPositionId: 1 }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      ...
      { text: '4. (조언을 더 얻고 싶다면 각 카드 아래에 추가 카드를 한 장씩 더 배치해 총 6장으로 리딩할 수도 있습니다.)' }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 질문을 마음 속으로 생각하며 세 장의 카드를 뽑아 좌, 중, 우 순서대로 놓습니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.', highlightPositionId: 2 },
      { text: '4. 뽑힌 카드들이 긍정(Yes), 부정(No), 중립(Neutral) 카드인지 분류합니다.\n3장이 모두 Yes면 확실한 긍정, 2장이 Yes면 긍정적이나 시간이 걸릴 수 있음을 뜻하며, No가 많거나 중립이 섞여 있다면 부정적인 결론에 가깝습니다.\n*역방향 카드를 사용하는 경우 역방향은 무조건 No로 해석합니다.' },
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 총 10장의 카드를 순서대로 십자가와 우측 세로 기둥 모양으로 배치합니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' },
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 총 5장의 카드를 순서대로 배치합니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 5장의 카드를 뽑아 구도에 맞게 배치합니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 리딩의 기준이 되는 시그니피케이터 카드를 가장 먼저 중앙에 놓습니다.', highlightPositionId: 1 },
      { text: '4. 현재 월 부터 시작하여 시계 방향으로 순서대로 카드를 놓습니다. 각 카드는 해당 월의 운세와 영향을 나타냅니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. 1주마다 2장의 카드를 배치하여 총 8장의 카드로 4주간의 운세를 리딩합니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ],
    positions: [
  ...
  },
  {
    ...
    readingSteps: [
      { text: '1. 알고 싶은 상황이나 질문에 집중하며 카드를 섞습니다.' },
      { text: '2. 카드를 뒷면이 보이게 부채꼴로 넓게 펼친 후, 주로 사용하지 않는 손으로 카드를 뽑습니다.' },
      { text: '3. Significator 카드를 뽑아 중앙에 위치합니다.', highlightPositionId: 1 },
      { text: '4. 그 주변으로 각 요일에 해당하는 카드를 아래의 정해진 번호 위치에 따라 배치합니다. 카드를 뒤집을 때는 반드시 왼쪽에서 오른쪽 방향으로 뒤집습니다.' }
    ],
    positions: [
