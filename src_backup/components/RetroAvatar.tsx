...
export const RetroGuideAvatar: React.FC<{ className?: string }> = ({ className = 'w-24 h-24' }) => {
  return (
    <svg
      viewBox="0 0 120 120"
    ...
    >
      ...
      <rect x="20" y="40" width="16" height="36" fill="black" stroke="white" strokeWidth="2.5" rx="6" />
      <rect x="84" y="40" width="16" height="36" fill="black" stroke="white" strokeWidth="2.5" rx="6" />

      {/* head circle */}
      <circle cx="60" cy="55" r="32" fill="black" stroke="white" strokeWidth="3" />
      ...
      {/* nose */}
      <polygon points="56,58 64,58 60,63" fill="white" stroke="white" strokeWidth="1" />
      
      {/* happy mouth & cheeks */}
      <path d="M 46 64 Q 60 76 74 64" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" />
...
export const RetroUserAvatar: React.FC<{ className?: string }> = ({ className = 'w-10 h-10' }) => {
  return (
    <svg
      viewBox="0 0 40 40"
    ...
    >
      ...
      <path d="M 8 16 L 8 28 L 11 28 L 11 20 L 29 20 L 29 28 L 32 28 L 32 16 Z" fill="white" />
      ...
      {/* Bangs tips */}
      <path d="M 10 16 L 14 19 L 18 16 L 22 19 L 26 16 L 30 19" fill="none" stroke="white" strokeWidth="1.5" />
      ...
      {/* Mouth */}
      <path d="M 18 27 Q 20 29 22 27" fill="none" stroke="white" strokeWidth="1" />
...
export const RetroCardBack: React.FC<{ className?: string }> = ({ className = 'w-32 h-48' }) => {
  return (
    <div className={`${className} bg-black border-2 border-white relative p-2 overflow-hidden flex flex-col justify-between items-center select-none`}>
      {/* Inner thin border */}
