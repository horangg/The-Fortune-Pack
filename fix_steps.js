...
file = file.replace(
  /id: 'past-present-future'[\s\S]*?readingSteps: \[\s*\{[\s\S]*?총 6장으로 리딩할 수도 있습니다.\)'\s*\}\s*\]/m,
  (match) => match.replace(/readingSteps: \[\s*\{[\s\S]*?총 6장으로 리딩할 수도 있습니다.\)'\s*\}\s*\]/m, `readingSteps: [
